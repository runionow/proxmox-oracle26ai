...
# Usage: bash <(curl -fsSL https://raw.githubusercontent.com/YOURUSERNAME/proxmox-oracle26ai/main/ct/oracle26ai.sh)
set -euo pipefail
...
CT_DISK_SIZE=$(whiptail_input "Resources" "Disk size in GB (min 20, recommended 32+):" "${CT_DISK_SIZE:-32}")
